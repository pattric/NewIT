...
dfs = pd.read_excel("./././export.xlsx", sheet_name=None)
df = dfs['EAI.TBLEVENT']
...
word_to_index, index_to_word, word_to_vec_map = read_glove_vecs(os.path.dirname(__file__)+'\data\glove.6B.50d.txt')
